...
$RutaInicio = "Liquidaciones/".$AñoD."/".$MesD."/LiquidacionSueldos_Rut_".$Rut.".pdf";
$RutaFin = "Liquidaciones/".$AñoH."/".$MesH."/LiquidacionSueldos_Rut_".$Rut.".pdf";

	$año = $AñoD;
	$mes = $mes1;		 
	echo "<table border='1' bordercolor='424242' class='grilla'>";
			...
			while($mes <= $MesH)
			{
				echo "<tr>";
					...
					if($mes < 10 && substr($mes,0,1) != 0)
					{
						...
						$directorio = "Liquidaciones/".$año."/".$x."/LiquidacionSueldos_Rut_".$Rut.".pdf";
						echo "<td>";
							echo "0$mes / $año ";							
						echo "</td>";						
		...
		{ 		
			...
			while($x <= $MesH)
			{
				...
				if($x < 10 && substr($x,0,1) != 0)
				{
					...
					$directorio = "Liquidaciones/".$año."/".$y."/LiquidacionSueldos_Rut_".$Rut.".pdf";
